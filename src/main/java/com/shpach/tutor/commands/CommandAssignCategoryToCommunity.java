 ...
 *
 */
public class CommandAssignCategoryToCommunity implements ICommand {
	private static final Logger logger = Logger.getLogger(CommandAssignCategoryToCommunity.class);
	...
	public String execute(HttpServletRequest request, HttpServletResponse responce)
		...
		boolean isOk = CommunityService.getInstance().assignCategoryToCommunity(categoryId, communityId);
		request.setAttribute("assignCategoryToCommunityStatus", isOk);
