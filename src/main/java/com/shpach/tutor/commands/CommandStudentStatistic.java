...
/**
 * Command which show statistic page for Student
 * 
 * @author Shpachenko_A_K
 *
 */
public class CommandStudentStatistic implements ICommand {
	private static final Logger logger = Logger.getLogger(CommandStudentStatistic.class);
	...
	public String execute(HttpServletRequest request, HttpServletResponse responce)
		...
		page = Config.getInstance().getProperty(Config.STUDENT_STATISTIC);
